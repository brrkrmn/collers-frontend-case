...
const HeroSection = () => {
  return (
    <div className="w-full h-full flex flex-col items-center justify-center px-4 laptop:px-20 gap-12 overflow-hidden">
      <div className="py-16 laptop:py-24 gap-12 flex flex-col laptop:flex-row items-center justify-center">
        ...
        <div className="flex items-center justify-center relative max-w-[367px] w-full">
          <Image src={Sneaker} alt="Sneaker" className="z-10 w-[120%] scale-[1.2] max-h-[350px] object-cover overflow-visible" />
          <span className="absolute top-10 bg-yellow-dark rounded-2xl w-[80%] h-full max-w-[367px] aspect-[3/5]"></span>
        </div>
      </div>
      <div className="py-16 flex flex-col tablet:flex-row items-center justify-center w-full gap-14 laptop:gap-20">
